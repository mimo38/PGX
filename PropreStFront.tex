...
\author{évêque et confesseur \\ patron du diocèse de Périgueux - Sarlat \\ titulaire de la cathédrale \\ avec partition grégorienne}
...
\subsection{Hymne de saint Front}
\cantus{Hymne}{ChristiDiscipulum}{Hymn.}{1.}
\end{document}
