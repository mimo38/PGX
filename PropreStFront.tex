...
\begin{document}
\vspace*{\stretch{1}}
\rubrica{La solennité de saint Front étant empêchée par la fête du Christ-Roile dernier dimanche d'octobre se fait, par décision diocésaine, le dimanche précédant le 25}
\vspace*{\stretch{0}}
\newpage
\maketitle
...
\subsection{Alleluia}
\cantus{Alleluia}{ParasMihi}{All.}{8.}
