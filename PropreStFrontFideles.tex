...
\subsection{Graduel}
\lettrine{É}{coutez}, mes fils, votre père~: servez Dieu dans la vérité, et cherchez-le pour faire ce qui lui plaît. \vb. Je vous avertis comme mes fils très chers : je vous ai en effet enfantés dans le Christ Jésus par l'Évangile.
...
\rubrica{\includegraphics[angle=45,height=2cm]{img/prier-un-automne-avec-les-saints-au-jour-le-jour}
